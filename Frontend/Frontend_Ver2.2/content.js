  ...
  if (!isLoading && !isError) {
    ...
    function addChatButton() {
      ...
      Object.assign(chatButtonContainer.style, {
        position: 'absolute',
        top: '25px',          // Move down, changed from 15px to 25px
        right: '25px',        // Move inward, changed from 15px to 25px
        zIndex: 99999
      });
      ...
      Object.assign(tooltip.style, {
        ...
        zIndex: '99999',
        right: '42px',  // Position tooltip to the left of the button
        top: '8px'      // Vertically center align
      });
      ...
      Object.assign(arrow.style, {
        position: 'absolute',
        top: '50%',
        right: '-4px',  // Arrow pointing to the right
        transform: 'translateY(-50%)',
        width: '0',
        height: '0',
        borderTop: '4px solid transparent',
        borderBottom: '4px solid transparent',
        borderLeft: '4px solid white'  // Left border forms triangle
      });
      tooltip.appendChild(arrow);
        ...
        if (category.title === "What personal information will be collected?" || category.title === "What will the personal information be used for?" || category.title === "Who will have access to your personal information?" ){
              ...
              function showExpandedSummary() {
                ...
                setTimeout(() => {
                    ...
                    if (originalHeight && originalHeight > 0) {
                      ...
                      allBubbles.forEach(b => {
                        if (window.getComputedStyle(b).display !== 'none') {
                          ...
                          const bubbleBottom = bubbleRect.top - categoryRect.top + bubbleRect.height + 20; // Add bottom margin
                  ...
                  Object.assign(contextLink.style, {
                    ...
                    transitionDelay: '0.25s', // Slightly slower than original text link for cascade effect
                  });
                  ...
                  detailExplanationBtn.addEventListener('click', (e) => {
                    e.preventDefault();
                    e.stopPropagation(); // Prevent event bubbling to avoid triggering collapse function
                  ...
                  summaryContent.appendChild(detailExplanationBtn); // Add Detail Explanation button
          ...
          category.data.forEach((item, itemIndex) => {
            ...
            Object.assign(detailExplanationBtn.style, {
              ...
              display: 'inline-block',
              marginBottom: '10px',
              marginLeft: '10px', // Space from original text link
              padding: '6px 12px', 
              backgroundColor: 'rgba(25, 118, 210, 0.1)',
              borderRadius: '4px',
              transition: 'all 0.3s ease',
              border: '1px solid rgba(25, 118, 210, 0.3)',
              opacity: '0', // Initially invisible, shown when expanded
            ...
            contentContainer.appendChild(detailExplanationBtn); // Add Detail Explanation button
