      ...
      categories.forEach((category, index) => {
        ...
        if (category.title === "What personal information will be collected?" || category.title === "What will the personal information be used for?" || category.title === "Who else will your personal information be shared with?" ){
            ...
            bubble.addEventListener('click', () => {
              ...
              function showExpandedSummary() {
                ...
                setTimeout(() => {
                  ...
                  detailExplanationBtn.innerText = "Detail Explanation";
                  ...
                  detailExplanationBtn.addEventListener('click', (e) => {
                    ...
                    window.privacyChatbox.openChatWindowWithAutoQuery(buttonRect, bubbleData);
                  });
          ...
          category.data.forEach((item, itemIndex) => {
            ...
            // Add hover effect
            detailExplanationBtn.addEventListener('mouseover', () => {
              detailExplanationBtn.style.backgroundColor = 'rgba(25, 118, 210, 0.2)';
              detailExplanationBtn.style.transform = 'translateY(0)';
            });
            
            detailExplanationBtn.addEventListener('mouseout', () => {
              detailExplanationBtn.style.backgroundColor = 'rgba(25, 118, 210, 0.1)';
              detailExplanationBtn.style.transform = 'translateY(0)';
            });
