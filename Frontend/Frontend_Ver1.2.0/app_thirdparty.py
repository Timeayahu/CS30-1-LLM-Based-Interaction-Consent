...
def summarize():
    try:
        ...
        print(data)
        response = model.invoke([HumanMessage(content=f"Identify third party type, create a summarization, and find orignial sentence for the following third party (recipients of user data): {data}\n\n"
                                         "Guidelines:\n"     
