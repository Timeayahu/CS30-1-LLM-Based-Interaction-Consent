        ...
        function: () => {
          ...
          function tryFuzzyMatch(searchText) {
            ...
            for (const element of elements) {
              ...
              if (!text || text.trim().length < 10) continue; // Exclude paragraphs that are too short
            ...
            if (candidateElements.length > 0) {
              ...
              // Restore element style, but keep slight highlight
              setTimeout(() => {
                ...
                // Fully restore
                setTimeout(() => {
                  bestMatch.element.style.backgroundColor = originalStyle.backgroundColor;
                  bestMatch.element.style.transition = originalStyle.transition;
                }, 3000);
              }, 2000);
              ...
              setTimeout(() => {
                ...
                allHighlights.forEach(highlight => {
                  ...
                  setTimeout(() => {
                    ...
                    highlight.style.boxShadow = originalBoxShadow;
                  }, 1000);
                });
