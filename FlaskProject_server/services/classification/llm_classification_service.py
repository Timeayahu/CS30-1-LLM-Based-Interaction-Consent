...
class ClassificationService:
    ...
    def classification_privacy_policy(self, privacy_dict):
        """
        Classify the privacy policy based on the 12 categories.
        """
        results = {}
        content = privacy_dict['content']
        # check if the content is in sensitive words
        ...
        # prompt the LLM to classify the privacy policy
        prompt = f"""
