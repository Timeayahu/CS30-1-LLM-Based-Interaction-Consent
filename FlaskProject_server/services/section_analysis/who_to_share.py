...
# prompt for the LLM to extract the third parties and purposes/scenarios from a privacy policy
prompt = """\
...
# third party categories derived from the GDPR
...
# response format for the LLM to extract the third parties and purposes/scenarios from a privacy policy
response_format = """\
{
...
# extract the third parties and purposes/scenarios from a privacy policy
def info_share(text):
    try:
        result = []
        ...
        # Call OpenAI API for extracting the third parties and purposes/scenarios from a privacy policy
        ...
        # prompt for the LLM to summarize the third parties and purposes/scenarios from a privacy policy
        analyse_prompt = f"""\
        ...
        # Call OpenAI API for summarizing the third parties and purposes/scenarios from a privacy policy
